    ...
    <div class="row container mx-auto">
        <div class="text-center mt-3 pt-5 col-lg-6 col-md-12 col-sm-12">
            ...
            <div class="account-info">
                ...
                <p><a href="index.php" id="logout-btn">Logout</a></p>    
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <form id="account-form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="account-password" name="password "palceholder="Password"required/>
                </div>
                <div class="form-group">
                    <label>Confirm Password</label>
                    <input type="password" class="form-control" id="account-password-confirm" name="confirmPassword "palceholder="Password"required/>
                </div>
                <div class="form-group">
